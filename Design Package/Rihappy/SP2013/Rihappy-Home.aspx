...
<asp:Content ContentPlaceholderID="PlaceHolderAdditionalPageHead" runat="server">
	<SharePointWebControls:CssRegistration name="/_catalogs/masterpage/Rihappy/css/Rihappy.css" After="<% $SPUrl:~sitecollection/Style Library/~language/Themable/Core Styles/pagelayouts15.css %>" runat="server" />
                ...
                <div class="sixteen columns">
                    <div class="flexslider">
                        <ul class="slides notloaded">
                            <li><img src="/_catalogs/masterpage/Rihappy/images/slides/slide1.jpg" alt="Cras pretium porttitor convallis" /></li>
                            <li><img src="/_catalogs/masterpage/Rihappy/images/slides/slide2.jpg" alt="Ut sed ligula vitae" /></li>
                            <li><img src="/_catalogs/masterpage/Rihappy/images/slides/slide3.jpg" alt="Integer dignissim tortor" /></li>
                        </ul>
                    </div>			
                </div>
            </div>
