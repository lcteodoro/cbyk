    ...
    <section id="blog" class="container">
        <div class="row">
            ...
            <div class="col-sm-8 col-sm-pull-4">
                <div class="blog">
                    <div class="blog-item">
                        <img class="img-responsive img-blog" src="https://rihappy365.sharepoint.com/sites/developer/_catalogs/masterpage/Rihappy/images/blog/blog1.jpg" width="100%" alt="" />
                        <div class="blog-content">
                            <a href="noticia-com-foto.aspx"><h3>Duis sed odio sit amet nibh vulputate cursus</h3></a>
                            ...
                            <a class="btn btn-default" href="blog-item.aspx">Leia Mais <i class="icon-angle-right"></i></a>
                        </div>
                    </div><!--/.blog-item-->
                    <div class="blog-item">
                        <div class="blog-content">
                            <a href="noticia-sem-foto.aspx"><h3>Conubia nostra per inceptos himenaeos</h3></a>
                            <div class="entry-meta">
                                <span><i class="icon-user"></i> <a href="#">João da Silva</a></span>
                                <span><i class="icon-folder-close"></i> <a href="#">Loren Ipsun</a></span>
                                <span><i class="icon-calendar"></i> 16 de setembro de 2016</span>
